    ...
    <nav id='navbar' className="bg-[#000000] border-gray-200 dark:bg-gray-900 fixed w-full z-50 top-0">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-around mx-auto p-4">
        ...
        <div className="flex items-center  md:order-2 space-x-1 md:space-x-0 rtl:space-x-reverse">
          ...
          <button data-collapse-toggle="navbar-language" type="button" className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-transparent focus:outline-none focus:ring-2 focus:ring-gray-600 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-language" aria-expanded="false">
          ...
          <ul className="flex flex-col font-medium gap-y-3 p-4 md:p-0 mt-4 border border-gray-100 rounded-lg  md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0  dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <ScrollLink
                ...
                offset={-70}
                duration={500}
                onClick={() => handleScrollOrRoute('home')}
            ...
            <li>
              <ScrollLink
                ...
                offset={-70}
                duration={500}
                onClick={() => handleScrollOrRoute('faqs')}
                className="text-white cursor-pointer"
              >
                FAQS
              </ScrollLink>
            ...
            <li>
              <ScrollLink
                ...
                offset={-70}
                duration={500}
                onClick={() => handleScrollOrRoute('contact')}
                className="text-white cursor-pointer"
              >
                Contact
              </ScrollLink>
